 ...
 */
@Generated
public class HairlabApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new HairlabApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new HairlabApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
