...
public class ProductCategoryRepository__BeanDefinitions {
  ...
  public static BeanDefinition getProductCategoryRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ProductCategoryRepository.class, ProductCategory.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.generation.hairlab.repository.ProductCategoryRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.generation.hairlab.repository.ProductCategoryRepositoryImpl__AotRepository(entityManager, context));
      }
    });
