...
/**
 * Bean definitions for {@link HairDyeRepository}.
 */
@Generated
public class HairDyeRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'hairDyeRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getHairDyeRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'hairDyeRepository'.
   */
  public static BeanDefinition getHairDyeRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, HairDyeRepository.class, HairDye.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.generation.hairlab.repository.HairDyeRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.HairDyeRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.generation.hairlab.repository.HairDyeRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getHairDyeRepositoryInstanceSupplier();
