...
public class ProductCategoryService__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<ProductCategoryService> getProductCategoryServiceInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ProductCategoryService>forConstructor(ProductCategoryRepository.class, ProductCategoryMapper.class)
            .withGenerator((registeredBean, args) -> new ProductCategoryService(args.get(0), args.get(1)));
  }
